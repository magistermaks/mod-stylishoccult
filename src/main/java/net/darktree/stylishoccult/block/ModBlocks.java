...
public class ModBlocks {
	...
	public static final Block ARCANE_ASH = RegUtil.block("arcane_ash", new ArcaneAshBlock(0.4f, RegUtil.settings(Material.SOIL, BlockSoundGroup.SAND, 2.0f, 6.0f, true).mapColor(MapColor.BLACK)));
